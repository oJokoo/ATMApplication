...
ATMLabel = tk.Label(loginScreen, text="OneTouch", font=('Helvatical bold', 20)).place(relx=0.5, rely=.1, anchor=CENTER)
...
createButton = Button(loginScreen, text="Create an Account", height=3, width=20, command=lambda: main.createScreen(1, loginScreen, createAccountScreen, welcomeScreen, depositScreen, withdrawScreen, helpScreen, thankyouScreen)).place(relx=0.5, rely=.8,
                                                                                                    anchor=CENTER)
...
depositButton = Button(welcomeScreen, text="Deposit", height=3, width=20, command=lambda: main.createScreen(2, loginScreen, createAccountScreen, welcomeScreen, depositScreen, withdrawScreen, helpScreen, thankyouScreen)).place(relx=0.05, rely=.90, anchor=W)
withdrawButton = Button(welcomeScreen, text="Withdraw", height=3, width=20, command=lambda: main.createScreen(4, loginScreen, createAccountScreen, welcomeScreen, depositScreen, withdrawScreen, helpScreen, thankyouScreen)).place(relx=0.95, rely=.90, anchor=E)
helpButton = Button(welcomeScreen, text="Help", height=2, width=10, command=lambda: main.createScreen(6, loginScreen, createAccountScreen, welcomeScreen, depositScreen, withdrawScreen, helpScreen, thankyouScreen)).place(relx=0.50, rely=.90, anchor=CENTER)
BackButton = Button(welcomeScreen, text="Logout", height=3, width=10, command=lambda: main.createScreen(8, loginScreen, createAccountScreen, welcomeScreen, depositScreen, withdrawScreen, helpScreen, thankyouScreen)).place(relx=0.05, rely=.75, anchor=W)
...
createAccountButton = Button(createAccountScreen, text="Create Account", height=3, width=20, command = lambda: main.createAccount(createUsernameText.get(), createPasswordText.get(), createEmailText.get(), initialDepositText.get(), loginScreen, createAccountScreen, createUsernameText, createPasswordText, createEmailText, initialDepositText)).place(relx=0.5, rely=.8,
                                                                                                    anchor=CENTER)
...
dReturnButton = Button(depositScreen, text="Back", height=2, width=10, command=lambda: main.createScreen(3, loginScreen, createAccountScreen, welcomeScreen, depositScreen, withdrawScreen, helpScreen, thankyouScreen)).place(relx=0, rely=0)
...
wReturnButton = Button(withdrawScreen, text="Back", height=2, width=10, command=lambda: main.createScreen(5, loginScreen, createAccountScreen, welcomeScreen, depositScreen, withdrawScreen, helpScreen, thankyouScreen)).place(relx=0, rely=0)

helpLabel = Label(helpScreen, text="Help Menu:", font=('Helvatical bold', 15)).place(relx=.5, rely=0.1, anchor=CENTER)
hReturnButton = Button(helpScreen, text="Back", height=2, width=10, command=lambda: main.createScreen(7, loginScreen, createAccountScreen, welcomeScreen, depositScreen, withdrawScreen, helpScreen, thankyouScreen)).place(relx=0, rely=0)
emailLabel = Label(helpScreen, text="help@onetouch.com", font=('Helvatical bold', 15)).place(relx=.5, rely=0.3, anchor=CENTER)
phoneNumberLabel = Label(helpScreen, text="214-696-9420", font=('Helvatical bold', 15)).place(relx=.5, rely=0.4, anchor=CENTER)
